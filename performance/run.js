...
if(process.platform === "darwin") {
    ...
    execSync('docker run --rm -v "$(pwd)":/sitespeed.io sitespeedio/sitespeed.io:12.2.0 --config=config/config-firefox.json --network=host http://host.docker.internal:8080/performance/performance.html', {stdio: 'inherit', cwd: __dirname});
} else {
